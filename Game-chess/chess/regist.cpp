    ...
    ui(new Ui::Form)
{
  ...
  //  widget->show();
   ...
   ui->label->setFont(font);
      ...
      ui->lineEdit_2->setPlaceholderText("确认密码!");
...
void Form::on_pushButton_2_clicked()
{
            ...
            if((name != "")&&(pass != "")&&(pass2 != "") )
            {
               if(pass == pass2)
               {
                  qDebug()<<"格式正确";
                  FILE * fp;            //定义一个文件流指针
                  if((fp = fopen("C:/Users/l1472/Desktop/chess1/chess/chess/player.txt","r+"))==NULL)
                  {
                      perror("fail to open!");
                  }
                  char temp[300];
                  ...
                  FILE * fp1;
                  if((fp1 = fopen("C:/Users/l1472/Desktop/chess1/chess/chess/player.txt","a+"))==NULL)
                  {
